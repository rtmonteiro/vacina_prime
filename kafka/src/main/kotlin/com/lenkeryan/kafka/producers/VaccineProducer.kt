package com.lenkeryan.kafka.producers

import br.lenkeryan.kafka.utils.TopicManager
import kotlinx.serialization.encodeToString
import kotlinx.serialization.json.Json
import com.lenkeryan.kafka.models.Coordinate
import com.lenkeryan.kafka.models.TemperatureInfo
...
object VaccineProducer : Runnable {
    ...
    private val sleepingTime = 5.0 // Time in seconds.
...
//            var temperature: Temperature = Temperature(Random.nextDouble())
    ...
    private fun getTemperatureInfo(): TemperatureInfo {
        val latitude = Random.nextDouble(-0.001, 0.001) + producerInfo!!.initialCoordinate.lat
        val longitude = Random.nextDouble(-0.001, 0.001) + producerInfo!!.initialCoordinate.lon
        val coord = Coordinate(latitude, longitude)
        val temp: Double
        if (temperatureOutOfBounds) {
            val vaccine = producerInfo!!.vaccines?.get(0)!!
